...
* **[Diversity](Diversity.html)**
  * The page will give you an overview of the different ways to estimate diversity.
* **[Functions](function_usage.html)**
  * The page gives an overview of the functions used, what they take as input, what they give as result and how they can be used on an example dataset.
* **[Examples](example.html)**
  * Examples of use cases for the Bayesian model using the NOVANA dataset. This will also include a comparison between using the developed method or only using observed abundance data for estimating species diversity. 
