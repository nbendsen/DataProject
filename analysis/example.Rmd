...
The first example works with the tertiary habitat "Nardus grasslands". First, we will study the effect of the beta binomial cover update function on the data viewed through different diversity measures. This will primarily be done by visual inspections. Lastly, the example will include a small study of the relation between pH value of the soil and species diveristy. 

The second example works with the tertiary habitat "Dry calcarous grasslands". This tertiary habitat is included to study the effect of nitrogen deposition on species diversity. In this example we also look at the effect of the beta binomial cover update function at site level as opposed to plot level as we only did in the first example.
