...
The other type is presence/absence data that indicates which species exists in a given area, but gives no information about their abundance. This data is binary and can be used to calculate the species richness of a site.
...
Opposite to the shannon index, the Hill-Shannon is not an entropy but a diversity. The Hill-Shannon diversity has the advantage that it emphasizes neither rare or common species.
