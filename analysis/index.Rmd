...
It can be seen in this example, that our way of calculating the shannon index gives a slightly higher value for most plots, but two plots with similar shannon index value with the simple way will still have comparable values with our way. Noticeably are the biggest difference among plots with a shannon value of 0 using the simpler method, that now have a value closer to 1 with our way of calculating the shannon index.
