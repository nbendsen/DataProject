...
One important assumption for the model is that species within the same tertiary habitat will follow the same spatial aggregated distribution. This assumption is used to develop the prior distribution for each species. <br>
