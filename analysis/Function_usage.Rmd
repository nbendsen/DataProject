...
* The function returns a dataframe with new abundance data.
...
* A vector with the shannon index for each plot in the input cover_data. First value in the vector corresponds to the first plot in the cover_data.
...
* A vector with simpson's index for each plot in the input cover_data. First value in the vector corresponds to the first plot in the cover_data.
...
* A vector with species richness for each plot in the input presence_absence_data. First value in the vector corresponds to the first plot in the cover_data.
...
* A vector with the Hill Shannon diversity for each plot in the input cover_data. First value in the vector corresponds to the first plot in the cover_data.
...
* A vector with the Hill Simpson diversity for each plot in the input cover_data. First value in the vector corresponds to the first plot in the cover_data.
...
* **data**: A data frame. Contains one or more columns of different diversity estimates of plots and also a column with some information about the plots.
