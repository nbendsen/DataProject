...
To illustrate how to use this function we use the mini examples of cover data and presence/absence data that we presented on [Introduction](Introduction.html). The cover data look like:
<br>
