...
Lastly, we will create a similar plot but with the Hill Simpson diversity used as test statistic. On the *"Comparison"* section on the [Example](example.html)  page we saw that the Hill Simpson diversity was the diversity estimator that gave a diversity estimate that differed the least between the beta binomial cover data and the observed cover data. 
