...
When referring to cover_data, it is data of the form:
...
colnames(Cover) <- c("Specie 1", "Specie 2", "Specie 3", "Specie 4", "Specie 5", "Specie 6", "Specie 7", "Specie 8", "Specie 9")

```

Cover data describes how much of the surface area that would be covered by a specific species if all the plats were projected down on the ground. In this example will cover data take the form of integer value from 0 to 16, where 16 is full cover and 0 is no cover, but it is also possible to us a percentage or other forms of cover data.
...
When referring to presence_absence_data, it is data of the form:
...
colnames(PresenceAbsence) <- c("Specie 1", "Specie 2", "Specie 3", "Specie 4", "Specie 5", "Specie 6", "Specie 7", "Specie 8", "Specie 9")
...
------
<h1>Beta Binomial Cover Update</h1>
------
...
------
<h3> Diversity profile comparison</h3>
------
