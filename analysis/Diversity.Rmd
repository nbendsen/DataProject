...
<br><br>
However, as it is pointed out in both [1] and [2] the shannon index is not a diversity, but rather a entropy giving the uncertainty in the outcome of a sampling process. This issue is highlighted in the following example taken from [2].
<br>
...
$$
where $S$ is the number of species in our precense/absence data having a one. This means that the species richness is just a count of how many species that is present in the plot without taking into account the distribution of the individuals among the specie types. This meassure is very influenced by rare species.
